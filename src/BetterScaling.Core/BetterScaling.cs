...
namespace BetterScaling {
    ...
    public class BetterScaling : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            // TODO description !!!
            HierarchyScaling = Config.Bind("General", "Hierarchy scaling", true, "REQUIRES RESTART! Enable toggling of hierarchy scaling. <INSERT ACCURATE DESCRIPTION HERE> DO NOT save / modify current scene after changing this setting!");
